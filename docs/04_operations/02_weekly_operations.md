# 02_週次運用（WeeklyOperations）

## 位置づけ
この文書は `04_運用（Operations）` に属する運用ドキュメントです。

## 目的
金曜13時リセットや週次レビューで確認する観点を整理する。
...
## 確認チェックリスト
- [ ] weekly reset の設定または運用状態を確認する
- [ ] usage review の設定または運用状態を確認する
- [ ] strategy review の設定または運用状態を確認する
- [ ] cleanup の設定または運用状態を確認する
