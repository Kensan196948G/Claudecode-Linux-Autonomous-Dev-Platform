# 03_戦略モード（StrategyModes）

## 位置づけ
この文書は `12_戦略（Strategy）` に属する運用ドキュメントです。

## 目的
balanced、growth、safe、finish-fast の使い分けを説明する。
...
## 確認チェックリスト
- [ ] balanced の設定または運用状態を確認する
- [ ] growth の設定または運用状態を確認する
- [ ] safe の設定または運用状態を確認する
- [ ] finish-fast の設定または運用状態を確認する
