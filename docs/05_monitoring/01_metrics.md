...
## 目的
memory、swap、CPU、load average、disk の監視項目を説明する。
...
## 確認チェックリスト
- [ ] memory_free_mb の設定または運用状態を確認する
- [ ] swap_used_mb の設定または運用状態を確認する
- [ ] cpu_percent の設定または運用状態を確認する
- [ ] loadavg_1m の設定または運用状態を確認する
